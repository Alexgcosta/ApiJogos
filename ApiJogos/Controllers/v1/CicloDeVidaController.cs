...
namespace ApiJogos.Controllers.v1
{
    ...
    public class CicloDeVidaIDController : ControllerBase
    {
        ...
        public CicloDeVidaIDController(IExemploSingleton exemploSingleton2, IExemploSingleton exemploSingleton1 = null)
        {
            this._exemploSingleton2 = exemploSingleton2;
            this._exemploSingleton1 = exemploSingleton1;
        }
        ...
        public CicloDeVidaIDController(IExemploSingleton exemploSingleton2)
        {
            _exemploSingleton2 = exemploSingleton2;
        }
        ...
        public override bool Equals(object obj)
        {
            return obj is CicloDeVidaIDController controller &&
                   EqualityComparer<IExemploSingleton>.Default.Equals(this._exemploSingleton2, controller._exemploSingleton2);
        }
